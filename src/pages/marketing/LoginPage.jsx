...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      cleanEmail === "demo@servora.com" &&
      (formData.password === "demo123" || formData.password === "demo")
    ) {
    ...
    try {
      ...
      throw new Error(
        "Invalid email or password. Please verify your credentials or register a new merchant account.",
      );
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col lg:flex-row overflow-hidden font-sans">
      <Helmet>
        ...
        <meta
          name="description"
          content="Sign in to your Servora dashboard to manage your restaurant, QR menus, and kitchen displays."
        />
      </Helmet>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-950 relative p-20 flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 space-y-12 mb-20">
          <div className="space-y-6">
            <Badge className="bg-blue-500/20 text-blue-400 border border-blue-500/30 px-4 py-1.5 font-black uppercase tracking-widest text-[10px]">
              Merchant Auth
            </Badge>
            ...
            <p className="text-xl text-slate-400 font-medium max-w-md leading-relaxed tracking-tighter">
              Access your command center to oversee operations, analyze
              performance, and manage your culinary empire.
            </p>
          </div>
        ...
        <div className="relative z-10 pt-12 border-t border-white/10 flex items-center justify-between">
          <div className="flex -space-x-3">
            ...
            <div className="w-10 h-10 rounded-full border-2 border-slate-950 bg-blue-600 flex items-center justify-center text-[10px] font-black text-white">
              +2k
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 lg:p-24 bg-white relative">
        ...
        >
          <div className="space-y-2">
            <h2 className="text-4xl font-black text-slate-950 tracking-tightest">
              Sign In.
            </h2>
            <p className="text-slate-500 font-medium">
              Access your Servora merchant dashboard
            </p>
          </div>

          {error && (
            <div className="p-4 rounded-2xl bg-rose-50 border border-rose-100/50 text-rose-600 flex items-start gap-3">
              <span className="w-5 h-5 mt-0.5 flex items-center justify-center rounded-full bg-rose-100 text-[10px] font-black shrink-0">
                !
              </span>
            ...
            <div className="space-y-6">
              ...
              <div className="pt-2">
                ...
                <button
                  type="button"
                  onClick={() =>
                    setFormData({ email: "demo@servora.com", password: "demo" })
                  }
