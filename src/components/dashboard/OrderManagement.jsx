                  ...
                  {processedOrders.map((order) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="h-full"
                      >
                        <Card className={`h-full overflow-hidden border border-slate-200/90 rounded-xl shadow-2xs hover:shadow-sm transition-all flex flex-col justify-between bg-white ${statusAccentClass}`}>
