        ...
        {mainTab === 'history' ? (
          ...
          <div>
            {loading && processedOrders.length === 0 ? (
              ...
              /* KDS Grid View Mode - Clean, Balanced & Luxury POS Ticket Design */
                ...
                <AnimatePresence>
                  {processedOrders.map((order) => {
                    ...
                    const statusAccentClass = 
                      order.status === ORDER_STATUS.PREPARING ? 'border-t-[3.5px] border-t-orange-500' :
                      order.status === ORDER_STATUS.READY ? 'border-t-[3.5px] border-t-emerald-500' :
                      order.status === ORDER_STATUS.SERVED ? 'border-t-[3.5px] border-t-purple-600' :
                      order.status === ORDER_STATUS.BILL_REQUESTED ? 'border-t-[3.5px] border-t-amber-500' :
                      order.status === ORDER_STATUS.FINISHED ? 'border-t-[3.5px] border-t-slate-300 opacity-80' :
                      order.status === ORDER_STATUS.CANCELLED ? 'border-t-[3.5px] border-t-rose-500 opacity-75' :
                      'border-t-[3.5px] border-t-indigo-600'
                    ...
                    return (
                      ...
                      >
                        <Card className={`h-full overflow-hidden border border-slate-200/90 rounded-2xl shadow-xs hover:shadow-md transition-all flex flex-col justify-between bg-white ${statusAccentClass}`}>
                          ...
                          <div>
                            <div className="p-2.5 px-3.5 border-b border-slate-100 flex items-start justify-between gap-2 bg-slate-50/70">
                              
                              {/* Table Badge & Identity */}
                              <div className="min-w-0 flex-1">
                                <div className="flex items-center gap-1.5">
                                  <span className="px-2 py-0.5 rounded-lg bg-slate-900 text-white font-black text-xs tracking-tight shadow-xs shrink-0">
                                    Table {order.tableNumber || order.table_number || '1'}
                                  </span>
                              ...
                              <div className="flex flex-col items-end gap-1 shrink-0">
                                <Badge className={`text-[8.5px] font-black uppercase tracking-wider px-2 py-0.5 border-none shadow-xs rounded-md ${
                            ...
                            <div className="p-2.5 px-3.5 bg-white">
                              <div className="flex items-center justify-between pb-1 mb-1.5 border-b border-dashed border-slate-200 text-[9px] font-bold text-slate-400 uppercase tracking-wider">
                              ...
                              <div className="space-y-1.5 min-h-[50px] max-h-[100px] overflow-y-auto pr-0.5">
                                {items.length === 0 ? (
                                  ...
                                  items.map((item, idx) => {
                                    ...
                                    return (
                                      ...
                                      >
                                        <div className={`w-4.5 h-4.5 rounded-md flex items-center justify-center shrink-0 font-black text-[9.5px] transition-colors shadow-2xs ${
                                          isChecked 
                                        ...
                                        <div className="flex-1 min-w-0">
                                          ...
                                          <div className="flex flex-wrap items-center gap-1 mt-0.2">
                                            {item.variant && item.variant !== 'full' && (
                                              <span className="text-[8px] font-bold text-amber-700 bg-amber-100/80 px-1 py-0.2 rounded">
                                                Half
                                              </span>
                                            )}
                                            {item.notes && (
                                              <span className="text-[8px] font-medium text-rose-600 bg-rose-50 px-1 py-0.2 rounded border border-rose-100">
                                                {item.notes}
                                              </span>
                                            )}
                                          </div>
                          ...
                          <div className="p-2.5 px-3.5 border-t border-slate-100 bg-slate-50/70 mt-auto">
                            ...
                            <div>
                              {[ORDER_STATUS.ORDERED, ORDER_STATUS.PENDING].includes(order.status) && (
                                <Button
                                  ...
                                  className="w-full h-7.5 rounded-xl bg-linear-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white font-bold text-xs uppercase tracking-wider shadow-xs active:scale-95 transition-all cursor-pointer flex items-center justify-center gap-1.5"
                                >
                              ...
                              {order.status === ORDER_STATUS.PREPARING && (
                                <Button
                                  ...
                                  className="w-full h-7.5 rounded-xl bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-bold text-xs uppercase tracking-wider shadow-xs active:scale-95 transition-all cursor-pointer flex items-center justify-center gap-1.5"
                                >
                              ...
                              {order.status === ORDER_STATUS.READY && (
                                <Button
                                  ...
                                  className="w-full h-7.5 rounded-xl bg-linear-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-bold text-xs uppercase tracking-wider shadow-xs active:scale-95 transition-all cursor-pointer flex items-center justify-center gap-1.5"
                                >
                              ...
                              {order.status === ORDER_STATUS.SERVED && (
                                <Button
                                  ...
                                  className="w-full h-7.5 rounded-xl bg-linear-to-r from-amber-500 to-yellow-600 hover:from-amber-600 hover:to-yellow-700 text-white font-bold text-xs uppercase tracking-wider shadow-xs active:scale-95 transition-all cursor-pointer flex items-center justify-center gap-1.5"
                                >
                              ...
                              {order.status === ORDER_STATUS.BILL_REQUESTED && (
                                <Button
                                  ...
                                  className="w-full h-7.5 rounded-xl bg-linear-to-r from-slate-900 to-slate-800 hover:from-black hover:to-slate-900 text-white font-bold text-xs uppercase tracking-wider shadow-xs active:scale-95 transition-all cursor-pointer flex items-center justify-center gap-1.5"
                                >
                              ...
                              {order.status === ORDER_STATUS.FINISHED && (
                                <Button
                                  variant="outline"
                                  onClick={() => setReceiptOrder(order)}
                                  className="w-full h-7.5 rounded-xl bg-white border-slate-200 text-slate-600 font-bold text-xs uppercase tracking-wider cursor-pointer flex items-center justify-center gap-1.5"
                                >
                              ...
                              {order.status === ORDER_STATUS.CANCELLED && (
                                <Button
                                  disabled
                                  className="w-full h-7.5 rounded-xl bg-rose-50 text-rose-600 border border-rose-200/60 font-bold text-xs uppercase tracking-wider opacity-90 flex items-center justify-center gap-1.5"
                                >
