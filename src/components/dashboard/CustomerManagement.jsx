...
const exportPDF = async (list, stats = {}, restaurantName = 'Tiger Bistro') => {
  const {
    ...
    reportSubtitle: 'Guest Lifetime Value, retention dynamics, and behavioral loyalty audit',
  ...
  const tableHeaders = [['#', 'Guest Identity', 'Contact Number', 'Tier', 'Visits', 'Total Spend', 'Score', 'Health']]
  ...
  autoTable(doc, {
    ...
    columnStyles: {
      0: { halign: 'center', cellWidth: 10, fontStyle: 'bold', textColor: [148, 163, 184] },
