  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4 sm:p-6 bg-slate-950/65 backdrop-blur-md animate-in fade-in duration-200">
      ...
      >
        ...
        <div className="h-1.5 w-full bg-linear-to-r from-rose-500 via-red-600 to-amber-500" />
        ...
        <div className="p-6 text-center">
          ...
          <div className="mx-auto mb-4 w-16 h-16 rounded-full bg-red-50 dark:bg-red-950/50 border-2 border-red-100 dark:border-red-900/50 flex items-center justify-center shadow-inner relative group">
            ...
            <div className="w-12 h-12 rounded-full bg-linear-to-br from-red-500 to-rose-600 flex items-center justify-center shadow-lg shadow-red-500/30 text-white relative">
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <Button
              ...
              onClick={onConfirm}
              disabled={isDeleting}
              className="flex-1 h-11 bg-linear-to-r from-red-600 via-rose-600 to-red-700 hover:from-red-700 hover:to-rose-700 text-white font-semibold rounded-xl shadow-lg shadow-red-600/30 hover:shadow-red-600/50 transition-all active:scale-[0.98] disabled:opacity-70 flex items-center justify-center gap-2"
            >
              {isDeleting ? (
                <>
